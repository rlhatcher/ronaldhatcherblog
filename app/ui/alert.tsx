...
export function Alert ({
  ...
  children,
  ...props
}: { size?: keyof typeof sizes, children: React.ReactNode } & HeadlessDialogProps): React.ReactElement {
  return (
...
export function AlertTitle ({ className, ...props }: React.ComponentPropsWithoutRef<'div'>): React.JSX.Element {
  return (
    <HeadlessDialogTitle
      {...props}
      className={clsx(
...
export function AlertDescription ({ className, ...props }: React.ComponentPropsWithoutRef<'div'>): React.JSX.Element {
  return (
    <HeadlessDescription
      as={Text}
      {...props}
...
export function AlertBody ({ className, ...props }: React.ComponentPropsWithoutRef<'div'>): React.JSX.Element {
  return <div {...props} className={clsx(className, 'mt-4')} />
}

export function AlertActions ({ className, ...props }: React.ComponentPropsWithoutRef<'div'>): React.JSX.Element {
  return (
    <div
      {...props}
      className={clsx(
